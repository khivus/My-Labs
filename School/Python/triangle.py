...
ent_res=Entry(root,width=10)
ent_res.place(x=465,y=200)
lbl_res=Label(root,text='Отношение площадей:',bg='gray80')
lbl_res.place(x=465,y=180)
...
def clk_but():
    ...
    canv.create_line(px(0),py(miny),
                     ...
                     arrow=LAST,
                     fill='gray50')
    canv.create_polygon(px(1),py(1),px(0),py(-1),px(-1),py(0),fill='',outline='black')
